...
DEFAULT_GROUPS = ["bhklab", "radiomics", "bhklab_icb", "bhklab_pmcc_gyn_autosegmentation", "bhklab_pmcc_gyn_gu"]
...
def build_group_membership_table(
    ...
    # the rest should be sorted alphabetically
        ...
        df = df[["name", "realname", "uid", "default_group"] + requested_cols + other_cols]
